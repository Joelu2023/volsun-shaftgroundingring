...
export const electricVehiclesApplicationPage: EvApplicationPageData = {
  ...
  durabilityMetrics: [
    { id: "dur-1", label: "Contact stability", value: "Stable shaft contact", note: "Fiber contact structure is reviewed for high-speed operation without publishing unconfirmed numeric claims." },
    { id: "dur-2", label: "Oil environment", value: "Common transmission oils", note: "Compatibility is described by application environment rather than unconfirmed test data." },
  ...
  faq: {
    en: [
      ...
      { id: "ev-faq-3", question: "Can the contact structure work in oil-cooled environments?", answer: "The permitted P0 claim is that it is suitable for oil-cooled EV motors and compatible with common transmission oil environments." },
    ...
    zh: [
      ...
      { id: "ev-faq-3", question: "接触结构能否用于油冷环境？", answer: "本轮 P0 允许表述为：适用于油冷 EV 电机，并兼容常见变速箱油环境。" },
  ...
  locales: {
    en: {
      ...
      mediaSlotsBody: "Only approved EV application imagery is used in this P0 update.",
      ...
      provenBody: "The permitted P0 claim is that the product is suitable for oil-cooled EV motors and compatible with common transmission oil environments.",
      ...
      trustedBody:
        "Proven applications across EV motors, industrial motors, pump systems, and wind power. No unconfirmed customer logos are used in this release.",
    ...
    zh: {
      ...
      mediaSlotsBody: "本轮 P0 仅使用已确认的 EV 应用图片。",
      ...
      provenBody: "本轮 P0 允许表述为：适用于油冷 EV 电机，并兼容常见变速箱油环境。",
      ...
      trustedTitle: "应用覆盖",
      trustedBody: "已应用于 EV 电机、工业电机、泵系统和风电等场景。本次发布不使用未经确认的客户 Logo。",
      scaleTitle: "量产导入支持",
