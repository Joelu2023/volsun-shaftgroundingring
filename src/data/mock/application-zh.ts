...
export const applicationZhBySlug: Record<string, ApplicationZhBody> = {
  ...
  "pump-systems": {
    ...
    summary:
      "面向变频泵电机的轴电压与轴承电流风险评审。只有在明确电机构造、轴几何、工况、接地和安装约束后，才选择轴接地方案。",
    metaDescription:
      "评审变频泵电机的轴电压与轴承电流风险。按轴几何、可达性、环境和安装约束选择轴接地环，而不是仅按功率选型。",
    problem:
      "变频泵电机可能因 PWM 共模应力和电容耦合产生轴电压。该电压可能经轴承泄放，但轴承失效也可能来自机械、润滑或对中原因。",
    whyItMatters:
      "只有在评审电机构造、轴几何、工况、接地、轴承配置和安装约束之后，才应选择轴接地环。RD/RDW 整环、ST/STW 弧形环或定制方案按适配评审，而不是仅按电机功率选型。",
    typicalRisks: [
      "反复更换轴承仍需同时做电气与机械评审",
      "搓板纹或霜状外观只是诊断线索，不是完整结论",
      "可达性、潮湿、联轴器路径和改造包络使适配更难",
      "轴电压未测量，或被当成与轴承电流相同的量",
      "未提供轴和包络数据，仅按功率选择接地方案",
    ],
    checklist: [
      "电机类型",
      "电机功率",
  ...
  "israel-aquaculture-pump-motor-75kw": {
    ...
    summary:
      "行业：水泵 · 水产养殖 · 以色列。真实案例：变频水泵电机反复出现轴承电腐蚀及相关失效风险，采用沃尔兴 VS-RDW 轴接地环后得到缓解，相较进口方案具备更好的批量成本与可靠性平衡。",
    metaDescription:
      "案例：以色列水泵制造商（水产养殖/工业水系统）在 75 kW 变频泵电机上通过沃尔兴 VS-RDW 第三代轴接地环缓解轴承腐蚀相关问题。",
    problem:
      "客户为以色列领先的水泵制造企业之一，产品覆盖工业泵与增氧等水产设备。现场反复出现电机轴承腐蚀，导致提前失效与维护频次上升。技术分析指向轴电压与杂散电流，这在变频驱动电机中较为典型。客户曾评估知名进口轴接地环，但单价偏高，难以在多台泵组上规模化推广。",
    whyItMatters:
