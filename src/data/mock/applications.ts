...
export const applications: ApplicationDetail[] = [
  ...
  },
  {
    ...
    summary:
      "For VFD-driven pump motors where shaft voltage and bearing current may contribute to electrical bearing damage. Review grounding only after motor construction, shaft geometry, duty, grounding, and installation constraints are known.",
    coverImagePublicPath: "/images/home/home-pump-systems-cover-en-v1.webp",
    heroImagePublicPath: "/images/applications/industrial/industrial-app-pump-v1.png",
    phase: "p0",
    ...
    problem:
      "VFD-driven pump motors can develop shaft voltage through PWM common-mode stress and capacitive coupling. That voltage may discharge through bearings, but bearing failure can also come from mechanical, lubrication, or alignment causes.",
    whyItMatters:
      "A shaft grounding ring should be selected only after reviewing motor construction, shaft geometry, operating conditions, grounding, bearing arrangement, and installation constraints. Solid RD/RDW, arc-shaped ST/STW, or custom options are reviewed by fit—not by motor power alone.",
    typicalRisks: [
      "Repeated bearing replacement that still needs electrical and mechanical review",
      "Fluting or frosting appearance that is a diagnostic clue, not a complete diagnosis",
      "Access, humidity, coupling paths, and retrofit envelope making fit review harder",
      "Shaft voltage left unmeasured or treated as the same quantity as bearing current",
      "Grounding selected from motor power without shaft and envelope data",
    ],
    recommendedProducts: ["split-shaft-grounding-ring", "solid-shaft-grounding-ring", "custom-shaft-grounding-ring"],
    checklist: [
      "Motor type",
    ...
    primaryCtaLabel: "Send Your Pump Motor Data for Review",
    primaryCtaHref: "/contact?cta_key=engineer&application_interest=pump-systems&inquiry_type=technical_inquiry",
