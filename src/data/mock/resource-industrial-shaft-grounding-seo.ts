...
export const industrialShaftGroundingSeoPage: IndustrialShaftGroundingSeoPageData = {
  ...
  checklistItems: {
    en: [
      ...
      "Engineering support for mixed fleets: OEM new builds and retrofit envelopes.",
    ],
    zh: [
      "针对变频工况轴电压的可控泄放路径，而非仅满足机械装配。",
      "材料与结构适配现场环境（粉尘、冲洗、温变等）。",
      "与维护模式一致的安装说明与检修可达性。",
      "支持混合设备群：新机导入与改造包络的工程协同。",
    ],
  },
  ...
  locales: {
    en: {
      ...
      relatedProgramBody:
        "The industrial motors application page focuses on proof, comparison, OEM/retrofit integration, and conversion CTAs—while this guide stays educational for search visitors.",
    ...
    zh: {
      ...
      relatedProgramBody:
        "工业电机应用页侧重证据、对比、OEM/改造集成与询盘转化；本页保持教育检索入口，避免与落地页抢同一叙事。",
